        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerDebt = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StockDetailName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AppUserId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockDetails_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Debt_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Debt_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockAnyDetail = table.Column<double>(type: "float", nullable: false),
                    AppUserId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stock_StockDetails_StockDetailId",
                        column: x => x.StockDetailId,
                        principalTable: "StockDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Stock_Users_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayOffDebt", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayOffDebt_Debt_DebtId",
                        column: x => x.DebtId,
                        principalTable: "Debt",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockBasket", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockBasket_Invoice_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoice",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StockBasket_Stock_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "a12c2d04-a9a7-42e8-b828-9e1003179a86", "Admin", "ADMIN" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, "ee8fd908-ae3b-4349-b510-93b4d7bb4868", "serdehablog@gmail.com", true, "Admin", "/userImages/defaultUser.png", "User", false, null, "SERDEHABLOG@GMAIL.COM", "SERDEHA", "AQAAAAEAACcQAAAAEGW3wKPmGax3XAl1mossfx65v1IXTsFW1OqmRVBwaDNU7zAmN4H43OdyV9UNM5iOFw==", "+905555555555", true, "e9da579c-0ae0-4293-88b1-f8b9e15b3af1", false, "serdeha" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBasket_InvoiceId",
                table: "StockBasket",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_StockBasket_StockId",
                table: "StockBasket",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_StockDetails_AppUserId",
                table: "StockDetails",
                column: "AppUserId");
